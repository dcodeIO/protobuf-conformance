...
Note: Text Format conformance is tracked separately from the Required and Recommended columns. protobuf.js currently runs the dedicated Text Format suite with 0 failures; the other implementations tested do not currently implement Text Format.
